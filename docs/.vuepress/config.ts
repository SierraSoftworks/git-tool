...
export default defineUserConfig({
    ...
    head: [
        ["meta", {
            name: "description",
            content:
                "Documentation for Git-Tool, a powerful command-line helper which keeps your Git repositories organized automatically.",
        }],
    ...
    theme: defaultTheme({
        ...
        navbar: [
            ...
            },
            {
                ...
                link:
                    "https://github.com/SierraSoftworks/git-tool/issues/new/choose",
                target: "_blank",
            },
        ],
